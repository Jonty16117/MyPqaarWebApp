...
import styles from "../../../styles/RemoveTruckReqItem.module.css";
import Viewer from "react-viewer";
import removeTruck from "../../../redux/actions/removeTruck";
import rejectTruckReq from "../../../redux/actions/rejectTruckReq";


function RemoveTruckReqItem(props) {
  ...
  const handleOnClickModalConfirm = (e) => {
    ...
    if (onClickButtonInfo === "Accept") {
      ...
      props.removeTruck(props.OwnerUId, props.TruckNo, props.FirstName, props.LastName)
...
const mapStateToProps = (state) => {
  return {
    removingTruck: state.firestore.removingTruck,
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    removeTruck: (ownerUId, truckNo, ownerFirstName, ownerLastName) => dispatch(removeTruck(ownerUId, truckNo, ownerFirstName, ownerLastName)),
    rejectTruckReq: (truckNo) => dispatch(rejectTruckReq(truckNo)),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(RemoveTruckReqItem);
